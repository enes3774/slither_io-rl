...
class Actor:
    ...
    def __init__(self, state_size, action_size, fc1_units=128, fc2_units=64, name="Actor"):
...
class Critic:
    ...
    def __init__(self, state_size, action_size, fc1_units=128, fc2_units=64, name="Critic"):
